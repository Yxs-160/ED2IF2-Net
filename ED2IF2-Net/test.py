...
# from datasets.SDFDataset import process_transmat
...
def test_all(config):
    ...
    with torch.no_grad():
        ...
        for data in testset.datalist:
            ...
            # index = index + 1
        # test_one_without_gttransmat(CAMmodel, SDFmodel, gridworldcoords, output_dir, config)
